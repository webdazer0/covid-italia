...
function Sidebar({ col }) {
  ...
  const confirmed = UtilsNumber.format(info.confirmed);
  const recovered = UtilsNumber.format(info.recovered);
  const deaths = UtilsNumber.format(info.deaths);
    ...
    <div className={classColumn}>
      <div className="card text-center">
        ...
        <div className="card-body pt-5">
          ...
          <p className="lead mb-5">
            <span className="text-success h1">{recovered}</span>
            <br />
